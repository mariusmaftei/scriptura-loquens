...
Send feedbackGenerate content with the Gemini API in Vertex AI
...
The range of values and default value is specific for each model. See the temperature ranges and default values table.
...
The following table lists the supported temperature range and default value for each model:

Model Temperature range Default value
gemini-2.0-flash-lite 0.0 - 2.0 1.0
gemini-2.0-flash 0.0 - 2.0 1.0
